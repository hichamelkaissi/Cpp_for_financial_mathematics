...
// Improved norminv function with an optional parameter to control exception throwing
double norminv(double x, bool throwException = true) {
    if (throwException && (x < 0.0 || x > 1.0)) {
